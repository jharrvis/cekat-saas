                    ...
                    <div>
                        ...
                        <select name="ai_model"
                            ...
                            @foreach($llmModels as $model)
                                <option value="{{ $model->model_id }}" {{ old('ai_model', 'google/gemini-2.0-flash-001') === $model->model_id ? 'selected' : '' }}>
                                    {{ $model->name }} - {{ $model->tier }}
                                </option>
                            @endforeach
                        </select>
                        <p class="text-xs text-muted-foreground mt-1">Model yang lebih besar menghasilkan jawaban lebih baik tapi lebih mahal</p>
                    </div>
