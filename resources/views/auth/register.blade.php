    ...
    <div class="min-h-screen flex">
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
            <div class="w-full max-w-md">
                ...
                <p class="text-slate-600 mb-8">Start building your AI chatbot today</p>

                {{-- Google SSO Button --}}
                <a href="{{ route('google.login') }}"
                    class="w-full flex items-center justify-center gap-3 px-6 py-3 border-2 border-slate-200 rounded-lg hover:bg-slate-50 transition mb-6">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus
                            class="w-full px-4 py-3 border border-slate-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('name') border-red-500 @enderror">
                        @error('name')
        ...
        <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 to-slate-700 items-center justify-center p-12">
            <div class="text-center text-white">
                <div class="mb-8">
                    <i class="fa-solid fa-robot text-8xl opacity-20"></i>
                </div>
                <h2 class="text-4xl font-bold mb-4">Build Your AI Chatbot</h2>
                <p class="text-xl text-slate-300 mb-8">Train with your data, deploy in minutes</p>
                <div class="flex gap-8 justify-center text-sm">
                    ...
                    <div>
                        ...
                        <div class="text-slate-400">Chats Handled</div>
                    </div>
                    <div>
